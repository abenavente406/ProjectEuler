...
public class UserInput {
    ...
    */
    ...
    public static short readShort() 
    {
        ...
        {   
          String userInput = new String(input.nextLine());
          returnValue = (Short.valueOf(userInput)).shortValue();
        }//end try
        catch(Exception e) 
        {
    ...
    public static float readFloat() 
    {
        ...
        {
            String userInput = new String(input.nextLine());
            returnValue = (Float.valueOf(userInput)).floatValue();
        }//end try
        catch(Exception e) {
           System.out.println("Exception while reading user's input as a " +
                              "float");	
    ...
    public static double readDouble() 
    {
        ...
        {
            String userInput = new String(input.nextLine());
            returnValue = (Double.valueOf(userInput)).doubleValue();
        }//end try
        catch(Exception e) 
        {
           System.out.println("Exception while reading user's input as a " +
    ...
    */
    ...
    public static long readLong() 
    {
        ...
        createInput();//Sets up Scanner object
         ...
         { 
             String userInput = new String(input.nextLine());
             returnValue = (Long.valueOf(userInput)).longValue();
         }//end try
         catch(Exception e) 
         { 
            System.out.println("Exception while reading user's input as a " +
    ...
    */
    ...
    public static boolean readBoolean() 
    {
         ...
         createInput();//Sets up Scanner object
          ...
          {
            String userInput = new String(input.nextLine());
            returnValue = (Boolean.valueOf(userInput)).booleanValue();
          }//end try
          catch(Exception e) 
          {
            System.out.println("Exception while reading user's input as a" +
  ...
  public static String formatFloat (float number, int align, int frac)
  {
   ...
   //===========================================================================
     ...
     * c://folder/file.txt
     * @throws java.io.IOException Thrown when a IO exception happens.
     * @see closeInputFile()
     */
   //===========================================================================
  ...
  /**
     ...
     * @throws java.io.IOException Thrown when an error occours.
     */
  //============================================================================
